...
class BottomAppBar4 extends StatefulWidget {
  const BottomAppBar4(
      {Key? key,
  ...
  final Function? centerClick;
  final List<TabIconData> tabIconsList;

  @override
  _BottomAppBar4State createState() => _BottomAppBar4State();
}

class _BottomAppBar4State extends State<BottomAppBar4>
