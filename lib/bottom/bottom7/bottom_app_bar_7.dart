...
/// 指示器 还有凸出高度
///
class BottomBar7 extends StatefulWidget {
  const BottomBar7({
    Key? key,
  ...
  @override
  _BottomBar7State createState() => _BottomBar7State();
}

class _BottomBar7State extends State<BottomBar7> with TickerProviderStateMixin {
